...
if __name__ == '__main__':
    ...
    action_file = 'toilet.xls'
    action_file2 = 'text0.xls'

    #打开文件
    wb = xlrd.open_workbook(filename=action_file)
    wb2 = xlrd.open_workbook(filename=action_file2)
    #通过索引获取表格sheet页
    sheet = wb.sheet_by_index(0)
    sheet2 = wb2.sheet_by_index(0)
    # text0 = '因无自来水，无法上水。'
    for i in range(10):
        mainWork(sheet,sheet2) 
